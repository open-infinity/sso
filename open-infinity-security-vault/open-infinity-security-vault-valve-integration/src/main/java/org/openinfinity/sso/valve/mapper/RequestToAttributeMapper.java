 ...
 * @since 1.0.0
 */
public class RequestToAttributeMapper {
	 ...
	 */
	public static final String USER_NAME = PropertiesUtil.loadValue(USERNAME_KEY);

	/**
	 * Represents the tenant's unique identifier attribute key.
	 */
	public static final String TENANT_ID = PropertiesUtil.loadValue(TENANT_ID_KEY);
	
	/**
	 * Represents the user roles attribute key.
	 */
	public static final String USER_ROLES = PropertiesUtil.loadValue(ROLES_KEY);
